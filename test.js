...
(async () => {
    ...
    let google_cookies = await harvester.login_to_google();
    // Open the harvester window, return the id of the harvester page.
    let harvester_id = await harvester.start_captcha_harvester(google_cookies);
